...
function AuctionPanel({
  ...
  const adjustBid = (playerId, delta) => {
    setBids((prev) => {
      const current = prev[playerId] ?? 0;
      const next = Math.max(0, current + delta);
      const player = players[playerId];
      return { ...prev, [playerId]: Math.min(next, (player == null ? void 0 : player.balance) ?? next) };
    });
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/80 flex items-end justify-center z-50 p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-900 rounded-t-3xl w-full max-w-md shadow-2xl overflow-hidden", children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-xs font-semibold uppercase tracking-widest", children: "Auction" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-black text-lg leading-tight", children: property.name })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-xs", children: "Listed At" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white font-bold text-xl", children: [
              "$",
              property.price,
              "M"
            ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-4 space-y-3 max-h-72 overflow-y-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-400 text-xs uppercase tracking-wide font-semibold", children: [
        "Place Bids (min increment $",
        MIN_INCREMENT,
        "M)"
      ] }),
      activePlayers.map((player, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-semibold text-sm truncate", children: player.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-400 text-[10px] font-mono", children: [
                "Balance: $",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-white font-bold text-sm w-16 text-center", children: [
                "$",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 pb-6 pt-2 flex gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          style: { backgroundColor: color },
          children: "🔨 Complete Auction"
        }
      )
    ] })
  ] }) });
}
const STARTING_BALANCE = 15e3;
const GO_SALARY = 2e3;
...
function getRent(property, properties, diceTotal) {
...
function advanceToNext(state) {
  ...
  if (active.length <= 1) {
    ...
    return {
      ...state,
      phase: "ended",
      winner: winner == null ? void 0 : winner.id,
...
function applyDiceRoll(state, d1, d2) {
  ...
  if (player.inJail) {
    if (d1 === d2) {
      ...
      return {
        ...
        diceRolled: true,
        players,
        message: player.inJail ? `${player.name} is still in Jail` : `${player.name} paid $500 fine`
      };
    }
  }
  ...
  let showPropertyCard = void 0;
  let showCardModal = void 0;
  ...
  switch (action.type) {
    ...
    case "BUY_PROPERTY": {
      ...
      const properties = state.properties.map(
        (p) => p.id === state.showPropertyCard ? { ...p, ownerId: player.id } : p
      );
    ...
    case "COMPLETE_AUCTION": {
      ...
      const properties = state.properties.map(
        (p) => p.id === state.auctionPropertyId ? { ...p, ownerId: winnerId } : p
      );
      ...
      return {
        ...
        showAuctionPanel: false,
        auctionPropertyId: void 0,
        message: `${updatedWinner.name} won auction for ${prop == null ? void 0 : prop.name} at $${bidAmount}M`
      };
    }
    ...
    case "DISMISS_CARD":
      return { ...state, showCardModal: void 0 };
    case "END_TURN":
      return advanceToNext({
        ...state,
        showPropertyCard: void 0,
        showCardModal: void 0,
        showBankingPanel: false,
        showTradePanel: false,
        pendingTrade: void 0,
        showAuctionPanel: false,
    ...
    case "MORTGAGE": {
      const properties = state.properties.map(
        (p) => p.id === action.propertyId ? { ...p, mortgaged: true } : p
      );
      const players = [...state.players];
      const player = { ...players[state.currentPlayerIndex] };
    ...
    case "UNMORTGAGE": {
      ...
      players[state.currentPlayerIndex] = player;
      const properties = state.properties.map(
        (p) => p.id === action.propertyId ? { ...p, mortgaged: false } : p
      );
      return {
        ...state,
        properties,
    ...
    case "BUILD_HOUSE": {
      ...
      players[state.currentPlayerIndex] = player;
      const properties = state.properties.map(
        (p) => p.id === action.propertyId ? { ...p, houses: p.houses + 1 } : p
      );
      const builtLabel = prop.houses + 1 >= 5 ? "Hotel" : `House (${prop.houses + 1})`;
      return {
        ...state,
        properties,
        players,
    ...
    case "CLOSE_TRADE":
      return { ...state, showTradePanel: false, pendingTrade: void 0 };
    case "SET_TRADE":
    ...
    case "EXECUTE_TRADE": {
      ...
      fromPlayer.balance = fromPlayer.balance - trade.offerCash + trade.requestCash;
...
const STORAGE_KEY$1 = "monopoly_game_state";
function loadState() {
  try {
...
function useGame() {
  const [state, dispatch] = reactExports.useReducer(gameReducer, void 0, loadState);
  const savedDispatch = reactExports.useCallback((action) => {
    dispatch(action);
  }, []);
...
function BankingPanel({
  ...
  function canBuyHouse(propId) {
    const prop = state.properties.find((p) => p.id === propId);
    if (!prop) return false;
    if (prop.mortgaged || prop.houses >= 5) return false;
    const cost = HOUSE_COST[prop.color];
    if (cost === void 0) return false;
    if (player.balance < cost) return false;
    const colorGroup = state.properties.filter((p) => p.color === prop.color);
    return colorGroup.every((p) => p.ownerId === player.id);
  }
  function houseLabel(houses) {
    if (houses === 0) return "";
    if (houses >= 5) return "🏨 Hotel";
    return "🏠".repeat(houses);
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/80 flex items-end z-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-900 rounded-t-3xl w-full max-h-[85vh] overflow-y-auto p-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-white font-bold text-lg", children: [
        "Banking — ",
        player.name
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-green-400 font-bold text-base mb-4", children: [
      "Balance: $",
      player.balance.toLocaleString(),
      "M"
    ] }),
    myProperties.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "p",
      {
    ...
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: myProperties.map((prop) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-medium text-sm leading-tight", children: prop.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-xs", children: prop.mortgaged ? "🔴 Mortgaged" : `$${prop.price}M` }),
              prop.houses > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-yellow-400 text-xs mt-[2px]", children: houseLabel(prop.houses) }),
              houseCost && !prop.mortgaged && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-500 text-[10px]", children: [
                "House: $",
                houseCost,
                "M"
              ] })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 flex-shrink-0", children: [
              !prop.mortgaged ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
              ...
              canBuy && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  ...
                  children: prop.houses >= 4 ? "🏨 Hotel" : "🏠 House"
                }
              ),
              canSell && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
...
function CardModal({ card, playerName, onDismiss }) {
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: {
            background: isChance ? "linear-gradient(135deg, #f97316 0%, #fb923c 40%, #fbbf24 100%)" : "linear-gradient(135deg, #2563eb 0%, #3b82f6 40%, #60a5fa 100%)"
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 pt-6 pb-4 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-5xl mb-2", children: isChance ? "?" : "🏘" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-black text-xl tracking-widest uppercase", children: isChance ? "Chance" : "Community Chest" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/95 mx-4 rounded-2xl px-5 py-5 mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-800 text-center font-semibold text-base leading-snug mb-4", children: card.title }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-gray-500 text-sm", children: [
                playerName,
                isPositive ? " receives" : " pays"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                style: {
                  backgroundColor: isChance ? "rgba(0,0,0,0.25)" : "rgba(0,0,0,0.25)",
...
function Die({ value, rolling, delayMs = 0 }) {
  const dots = DOTS[value] || DOTS[1];
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: `w-16 h-16 bg-white rounded-xl relative shadow-lg ${rolling ? "dice-rolling border-4 border-green-400" : "border-2 border-gray-300"}`,
      style: {
        ...rolling ? { animationDelay: `${delayMs}ms` } : {},
        transformStyle: "preserve-3d"
      },
      children: dots.map(([x, y]) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
...
function DicePair({ dice, rolling, tappable, onClick }) {
  if (tappable) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Die, { value: dice[0], rolling, delayMs: 0 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Die, { value: dice[1], rolling, delayMs: 50 })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-green-400 text-xs font-semibold tracking-wide animate-pulse", children: rolling ? "Rolling..." : "Tap to Roll" })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 justify-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Die, { value: dice[0], rolling, delayMs: 0 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Die, { value: dice[1], rolling, delayMs: 50 })
  ] });
}
function PropertyCard({
  ...
  const rentRows = property.color === "railroad" ? [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-900 rounded-2xl overflow-hidden w-full max-w-sm shadow-2xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "h-14 flex items-center justify-center",
        style: { backgroundColor: color },
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold text-base text-center px-4", children: property.name })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400 text-sm", children: "Price" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-white font-bold text-xl", children: [
          "$",
          property.price,
          "M"
        ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-xs mb-1 uppercase tracking-wide", children: "Rent Schedule" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-[3px]", children: rentRows.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400", children: row.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-200 font-medium", children: row.value })
        ] }, row.label)) })
      ] }),
...
const HOUSE_KEYS = ["h0", "h1", "h2", "h3"];
function getSpaceEmoji(space) {
  switch (space.type) {
    case "go":
      return "GO";
    case "go-to-jail":
...
function HouseIcons({ houses }) {
  if (houses === 0) return null;
  if (houses >= 5) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 8, lineHeight: 1 }, children: "🏨" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-[1px] justify-center", children: HOUSE_KEYS.slice(0, houses).map((key) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      style: {
        width: 4,
...
function BoardCell({
  ...
  const prop = space.propertyId ? properties.find((p) => p.id === space.propertyId) : void 0;
  ...
  const effectiveCurrentPos = animatingPlayer && currentPlayer.id === animatingPlayer.playerId ? animatingPlayer.position : currentPlayer.position;
  const isCurrentPos = effectiveCurrentPos === spaceIndex;
  const isCorner = (row === 0 || row === 10) && (col === 0 || col === 10);
  const isAnimatingHere = animatingPlayer !== null && animatingPlayer !== void 0 && animatingPlayer.position === spaceIndex;
  const colorHex = space.color ? COLOR_MAP[space.color] : null;
  const owner = (prop == null ? void 0 : prop.ownerId) !== void 0 ? players[prop.ownerId] : void 0;
  let bandPos = null;
  ...
  const shortName = space.name.length > 9 ? `${space.name.slice(0, 8)}…` : space.name;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        backgroundColor: isCurrentPos ? "#fef3c7" : isCorner ? "#f0e8d0" : "#faf6ed",
        border: "1px solid #1a5c28",
        boxShadow: isCurrentPos ? "inset 0 0 0 1.5px #f59e0b" : void 0,
        minWidth: 0,
        zIndex: isCurrentPos ? 10 : void 0
      },
      children: [
        colorHex && bandPos === "top" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        colorHex && bandPos === "bottom" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        colorHex && bandPos === "left" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        colorHex && bandPos === "right" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: isCorner ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-full gap-[1px]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  style: {
              ...
              !isProperty && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  style: {
                    fontSize: 7,
              ...
              prop && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  style: {
                    fontSize: 5,
              ...
              prop && prop.houses > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(HouseIcons, { houses: prop.houses })
            ] })
          }
        ),
        playersHere.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "flex flex-wrap gap-[1px] justify-center flex-shrink-0",
            style: { paddingBottom: 2 },
            children: playersHere.slice(0, 4).map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: isAnimatingHere && p.id === (animatingPlayer == null ? void 0 : animatingPlayer.playerId) ? "token-hop" : "",
                style: {
                  width: 20,
                  height: 20,
                  ...
                  fontSize: 12,
                  lineHeight: 1,
                  boxShadow: isAnimatingHere && p.id === (animatingPlayer == null ? void 0 : animatingPlayer.playerId) ? `0 0 8px ${p.color}, 0 2px 6px rgba(0,0,0,0.7)` : "0 1px 3px rgba(0,0,0,0.5)",
                  flexShrink: 0,
                  transition: "box-shadow 0.1s"
                },
                children: PLAYER_ANIMALS[p.id] ?? "🎮"
              },
              p.id
            ))
          }
...
function CenterDice({
  ...
  const [displayDice, setDisplayDice] = reactExports.useState(dice);
  reactExports.useEffect(() => {
    if (!rolling) {
      setDisplayDice(dice);
      return;
  ...
  const dieStyle = {
    ...
    fontWeight: 700,
    color: "#1a1a1a",
    boxShadow: rolling ? "0 3px 8px rgba(0,0,0,0.6), 0 0 0 1px rgba(255,255,255,0.3)" : "0 2px 4px rgba(0,0,0,0.4)",
    fontSize: "clamp(8px, 2vw, 14px)",
    width: "clamp(14px, 3.5vw, 26px)",
    height: "clamp(14px, 3.5vw, 26px)",
    transition: "box-shadow 0.1s"
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 mt-0.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: rolling ? "dice-rolling" : "", style: dieStyle, children: displayDice[0] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        style: {
          ...dieStyle,
          animationDelay: rolling ? "0.04s" : void 0
        },
        children: displayDice[1]
      }
    )
  ] });
}
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            GRID.map(
              (rowArr, row) => rowArr.map((spaceIndex, col) => {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1 select-none w-full px-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: "Ultimate Banking"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CenterDice, { dice, rolling }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center mt-1", style: { gap: 2 }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        style: {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center", style: { gap: 3 }, children: activePlayers.map((p, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        title: p.name,
                        style: {
                          ...
                          backgroundColor: p.color,
                          borderRadius: "50%",
                          border: p.id === currentPlayer.id ? "2px solid #ffd700" : "1.5px solid rgba(255,255,255,0.6)",
                          boxShadow: p.id === currentPlayer.id ? "0 0 6px #ffd700, 0 0 12px rgba(255,215,0,0.4)" : "0 1px 2px rgba(0,0,0,0.3)",
                          position: "relative",
                          display: "flex",
                          alignItems: "center",
                          justifyContent: "center",
...
function TradePanel({ state, onExecute, onClose }) {
  const currentPlayer = state.players[state.currentPlayerIndex];
  const otherPlayers = state.players.filter(
    (p) => p.id !== currentPlayer.id && !p.bankrupt
  );
  const [targetPlayerId, setTargetPlayerId] = reactExports.useState(
    otherPlayers.length > 0 ? otherPlayers[0].id : null
  );
  const [offerPropertyIds, setOfferPropertyIds] = reactExports.useState([]);
  const [offerCash, setOfferCash] = reactExports.useState(0);
  const [requestPropertyIds, setRequestPropertyIds] = reactExports.useState([]);
  const [requestCash, setRequestCash] = reactExports.useState(0);
  const [error, setError] = reactExports.useState("");
  const targetPlayer = targetPlayerId !== null ? state.players.find((p) => p.id === targetPlayerId) : null;
  const myProperties = state.properties.filter(
    (p) => p.ownerId === currentPlayer.id
  );
  const theirProperties = targetPlayer ? state.properties.filter((p) => p.ownerId === targetPlayer.id) : [];
  function toggleOfferProp(id) {
    setOfferPropertyIds(
      (prev) => prev.includes(id) ? prev.filter((x) => x !== id) : [...prev, id]
    );
  }
  function toggleRequestProp(id) {
  ...
  function handleExecute() {
    ...
    if (offerPropertyIds.length === 0 && offerCash === 0 && requestPropertyIds.length === 0 && requestCash === 0) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/80 flex items-end z-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-900 rounded-t-3xl w-full max-h-[90vh] overflow-y-auto p-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-bold text-lg", children: "🤝 Trade" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-green-400 font-bold text-sm mb-4", children: [
      currentPlayer.name,
      " — $",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "select",
        {
          ...
          children: otherPlayers.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: p.id, children: [
            p.name,
            " — $",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3 mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-yellow-400 font-semibold text-xs mb-2", children: "Your Offer" }),
        myProperties.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-xs", children: "No properties" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1 mb-2", children: myProperties.map((prop) => {
          const color = COLOR_MAP[prop.color] || "#888";
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            {
              htmlFor: checkId,
              className: `flex items-center gap-1.5 p-1.5 rounded-lg cursor-pointer text-xs ${checked ? "bg-yellow-900/40" : "bg-gray-800"}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-400 font-semibold text-xs mb-2", children: "You Request" }),
        theirProperties.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-xs", children: "No properties" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1 mb-2", children: theirProperties.map((prop) => {
          const color = COLOR_MAP[prop.color] || "#888";
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            {
              htmlFor: checkId,
              className: `flex items-center gap-1.5 p-1.5 rounded-lg cursor-pointer text-xs ${checked ? "bg-blue-900/40" : "bg-gray-800"}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
    ...
    (offerPropertyIds.length > 0 || offerCash > 0 || requestPropertyIds.length > 0 || requestCash > 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-800/60 rounded-xl p-3 mb-3 text-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 font-semibold mb-1", children: "Trade Summary" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-yellow-300", children: [
        currentPlayer.name,
        " gives:",
        " ",
        [
          ...offerPropertyIds.map(
            (id) => {
              var _a2;
              return (_a2 = state.properties.find((p) => p.id === id)) == null ? void 0 : _a2.name;
            }
          ),
          offerCash > 0 ? `$${offerCash}M cash` : null
        ].filter(Boolean).join(", ") || "nothing"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-blue-300", children: [
        targetPlayer == null ? void 0 : targetPlayer.name,
        " gives:",
        " ",
        [
...
function App() {
  ...
  const [animatingPlayer, setAnimatingPlayer] = reactExports.useState(null);
  ...
  const handleRollDice = () => {
    ...
    setTimeout(() => {
      ...
      const d2 = Math.floor(Math.random() * 6) + 1;
      const total = d1 + d2;
      const currentPlayer2 = state.players[state.currentPlayerIndex];
      if (currentPlayer2.inJail) {
        dispatch({ type: "ROLL_DICE_PREROLLED", dice: [d1, d2] });
        return;
      }
      const startPos = currentPlayer2.position;
      const playerId = currentPlayer2.id;
      let step = 0;
      const stepAnimation = () => {
        step += 1;
  ...
  if (state.phase === "lobby") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(HomeScreen, { onStart: () => dispatch({ type: "START_SETUP" }) });
  }
  ...
  if (state.phase === "ended") {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gray-950 flex flex-col items-center justify-center p-6 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-6xl mb-4", children: "🏆" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white text-3xl font-bold mb-2", children: "Winner!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: winner ? PLAYER_ANIMALS[winner.id] ?? winner.name[0].toUpperCase() : "?"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-yellow-400 text-2xl font-bold mb-2", children: winner == null ? void 0 : winner.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-green-400 text-xl mb-8", children: [
        "Final Balance: $",
        winner == null ? void 0 : winner.balance.toLocaleString(),
        "M"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
  ...
  const propertyToBuy = state.showPropertyCard ? state.properties.find((p) => p.id === state.showPropertyCard) : void 0;
  const auctionProperty = state.showAuctionPanel && state.auctionPropertyId ? state.properties.find((p) => p.id === state.auctionPropertyId) : void 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gray-950 text-white flex flex-col max-w-md mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-900 px-4 py-2 flex items-center justify-between border-b border-gray-800 flex-shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-green-400 font-bold text-sm leading-tight", children: "Monopoly" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-[9px] leading-tight", children: "Ultimate Banking" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 overflow-x-auto", children: state.players.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          "data-ocid": `game.player_balance.${i + 1}`,
          className: `flex-shrink-0 flex items-center gap-1 px-1.5 py-1 rounded-lg transition-all ${i === state.currentPlayerIndex ? "ring-2 ring-white/60 scale-105" : "opacity-60"} ${p.bankrupt ? "opacity-20" : ""}`,
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: PLAYER_ANIMALS[p.id] ?? p.name[0].toUpperCase()
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[9px] font-mono text-white leading-none", children: [
              "$",
              p.balance >= 1e3 ? `${(p.balance / 1e3).toFixed(1)}k` : p.balance,
              "M"
            ] }),
            p.inJail && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[8px]", children: "🔒" })
          ]
        },
        p.id
      )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-white/25 flex items-center justify-center text-lg", children: PLAYER_ANIMALS[currentPlayer.id] ?? currentPlayer.name[0].toUpperCase() }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white font-black text-base leading-tight", children: [
                currentPlayer.name,
                "'s Turn"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/80 text-xs font-mono leading-tight", children: [
                "Balance: $",
                currentPlayer.balance.toLocaleString(),
                "M"
              ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end gap-0.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/70 text-[10px] uppercase tracking-widest font-bold", children: "Turn" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-2xl leading-none", children: "↺" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/70 text-[10px] font-medium", children: "Anti-clockwise" })
          ] })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gray-800/90 px-4 py-1 text-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-yellow-300 text-xs leading-tight", children: state.message }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      SquareBoard,
      {
        spaces: BOARD_SPACES,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-900 px-4 py-3 space-y-2 border-t border-gray-800 flex-shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-gray-400 text-xs", children: currentPlayer.inJail ? "🔒 In Jail" : `📍 ${currentSpace.name}` }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        DicePair,
        {
          dice: state.dice,
          ...
          onClick: !state.diceRolled && !rolling ? handleRollDice : void 0
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        currentPlayer.inJail && !state.diceRolled && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => dispatch({ type: "PAY_JAIL" }),
            className: "flex-1 py-2.5 bg-red-700 rounded-xl font-bold text-sm",
            children: "Pay $500 Bail"
          }
        ),
        state.diceRolled && !state.showPropertyCard && !state.showCardModal && !state.showAuctionPanel && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
    ...
    propertyToBuy && /* @__PURE__ */ jsxRuntimeExports.jsx(
      PropertyCard,
      {
    ...
    auctionProperty && /* @__PURE__ */ jsxRuntimeExports.jsx(
      AuctionPanel,
      {
        property: auctionProperty,
        players: state.players,
        onComplete: (winnerId, bidAmount) => dispatch({ type: "COMPLETE_AUCTION", winnerId, bidAmount }),
        onCancel: () => dispatch({ type: "DISMISS_PROPERTY_CARD" })
      }
    ),
    state.showCardModal && /* @__PURE__ */ jsxRuntimeExports.jsx(
      CardModal,
      {
    ...
    state.showBankingPanel && /* @__PURE__ */ jsxRuntimeExports.jsx(
      BankingPanel,
      {
        state,
        onMortgage: (id) => dispatch({ type: "MORTGAGE", propertyId: id }),
        onUnmortgage: (id) => dispatch({ type: "UNMORTGAGE", propertyId: id }),
    ...
    state.showTradePanel && /* @__PURE__ */ jsxRuntimeExports.jsx(
      TradePanel,
      {
        state,
...
function HomeScreen({ onStart }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gray-950 flex flex-col items-center justify-center p-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-7xl mb-4", children: "🎩" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white text-4xl font-extrabold mb-1", children: "Monopoly" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-green-400 text-xl font-semibold tracking-wider", children: "ULTIMATE BANKING" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-xs space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: "🌐 Online (Coming Soon)"
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-sm mt-8", children: "2-6 players · Pass & Play" })
  ] });
}
const PLAYER_SLOTS = ["p1", "p2", "p3", "p4", "p5", "p6"];
function SetupScreen({
  ...
  const handleStart = () => {
    const players = names.slice(0, count).map((name) => ({ name: name.trim() || "Player" }));
    onStart(players);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gray-950 p-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white text-2xl font-bold mb-6 text-center", children: "Game Setup" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "select",
        {
          ...
          children: [2, 3, 4, 5, 6].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: n, children: [
            n,
            " Players"
          ] }, n))
        }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 mb-8", children: PLAYER_SLOTS.slice(0, count).map((slotId, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "w-10 h-10 rounded-full flex items-center justify-center text-xl flex-shrink-0",
          style: { backgroundColor: PLAYER_COLORS[i] },
          children: PLAYER_ANIMALS[i]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-xs text-center mt-4", children: "Each player starts with $15,000M" })
  ] });
}
