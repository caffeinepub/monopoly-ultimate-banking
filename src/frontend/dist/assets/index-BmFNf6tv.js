...
function gameReducer(state, action) {
  switch (action.type) {
    ...
    case "DISMISS_PROPERTY_CARD":
      return { ...state, showPropertyCard: void 0 };
    case "DISMISS_CARD":
...
function Die({ value, rolling, delayMs = 0 }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: `w-14 h-14 bg-white rounded-xl border-2 border-gray-300 relative shadow-lg ${rolling ? "dice-rolling" : ""}`,
      style: rolling ? { animationDelay: `${delayMs}ms` } : void 0,
            ...
            children: playersHere.slice(0, 4).map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                style: {
                  ...
                  borderRadius: "50%",
                  boxShadow: isAnimatingHere && p.id === (animatingPlayer == null ? void 0 : animatingPlayer.playerId) ? `0 0 6px ${p.color}, 0 2px 4px rgba(0,0,0,0.6)` : "0 1px 2px rgba(0,0,0,0.4)",
                  flexShrink: 0,
              ...
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1 select-none w-full px-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center mt-1", style: { gap: 2 }, children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center", style: { gap: 2 }, children: activePlayers.map((p, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        title: p.name,
                        style: {
                          ...
                          boxShadow: p.id === currentPlayer.id ? "0 0 4px #ffd700" : "0 1px 2px rgba(0,0,0,0.3)",
                          position: "relative"
                        },
                        children: idx === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
                            style: {
                              position: "absolute",
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gray-950 flex flex-col items-center justify-center p-6 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: winner == null ? void 0 : winner.name[0].toUpperCase()
        }
      ),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gray-950 text-white flex flex-col max-w-md mx-auto", children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-white/25 flex items-center justify-center text-sm font-black text-white", children: currentPlayer.name[0].toUpperCase() }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end gap-0.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/70 text-[10px] font-medium", children: "Clockwise" })
          ] })
        ]
      }
    ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-900 px-4 py-3 space-y-2 border-t border-gray-800 flex-shrink-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        ...
        state.diceRolled && !state.showPropertyCard && !state.showCardModal && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
